"""
Django settings for curtis_test_qa_app_217 project.
...
ROOT_URLCONF = 'curtis_test_qa_app_217.urls'
...
WSGI_APPLICATION = 'curtis_test_qa_app_217.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_qa_app_217 API",
    "DESCRIPTION": "API documentation for curtis_test_qa_app_217 App",
    "VERSION": "v1",
}
